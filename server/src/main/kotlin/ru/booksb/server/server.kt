...
fun main() {
    ...
    Javalin.create()
        ...
        .get("/api/v1/users", serverCtx.getUsersHandler, roles(ANY, ADMIN))
        .post("/api/v1/users", serverCtx.createUserHandler, roles(ANY, ADMIN))
        .post("/api/v1/books/upload", serverCtx.uploadFileHandler, roles(ANY, ADMIN))
        .post("/api/v1/books/reimport", serverCtx.reimportFileHandler, roles(ANY, ADMIN))
        .get("/api/v1/books", serverCtx.allBooksHandler, roles(ANY, LOGGED_IN))
        .get("/api/v1/books/:id", serverCtx.booksHandler, roles(ANY, LOGGED_IN))
        .get("/api/v1/books/:id/view", serverCtx.bookContentHandler, roles(ANY, LOGGED_IN))
        .get("/api/v1/books/:id/view/:elementid", serverCtx.bookContentHandler, roles(ANY, LOGGED_IN))
